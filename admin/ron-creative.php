<?php
// File: /admin/ron-creative.php (DEFINITIVE FINAL - All functions restored & included)
...
<div class="modal fade" id="previewModal" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="previewModalLabel">Creative Preview</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body"><div id="preview-content" class="text-center bg-light p-3" style="min-height: 250px; display: flex; justify-content: center; align-items: center;"></div></div></div></div></div>
<div class="modal fade" id="statusCreativeModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Confirm Status Change</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><form action="ron-creative-action.php" method="POST"><div class="modal-body"><input type="hidden" name="creative_id" id="status-creative-id"><input type="hidden" name="campaign_id" value="<?php echo $campaign_id; ?>"><input type="hidden" name="current_status" id="status-creative-current-status"><p>Are you sure you want to <strong id="status-creative-action-text"></strong> the creative: <strong id="status-creative-name"></strong>?</p></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" name="update_creative_status" class="btn btn-primary" id="status-creative-confirm-btn">Confirm</button></div></form></div></div></div>
<div class="modal fade" id="deleteCreativeModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Confirm Deletion</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><form action="ron-creative-action.php" method="POST"><div class="modal-body"><input type="hidden" name="creative_id" id="delete-creative-id"><input type="hidden" name="campaign_id" value="<?php echo $campaign_id; ?>"><p>Are you sure you want to delete this creative: <strong id="delete-creative-name"></strong>?</p></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" name="delete_creative" class="btn btn-danger">Delete</button></div></form></div></div></div>
