<?php
// File: /admin/ron-creative-action.php (FINAL & COMPLETE - All functions included)
...
if (isset($_POST['apply_bulk_action'])) {
    ...
    switch ($action) {
        case 'delete':
            // Sebelum menghapus, ambil path file untuk dihapus dari server
...
if (isset($_POST['add_creative'])) {
    ...
    if ($creative_type === 'image') {
        ...
        $sizes_db = 'all'; // Script type biasanya cocok untuk semua ukuran
