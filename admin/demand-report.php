<?php
// File: /admin/demand-report.php (NEW)
...
$group_by_field = "";
switch ($group_by) {
    case 'date': $group_by_field = "cs.stat_date"; $main_column_header = "Date"; break;
    case 'country': $group_by_field = "cs.country"; $main_column_header = "Country"; break;
    default: $group_by_field = "sp.name"; $main_column_header = "Demand Partner"; break;
}
...
$sql = "
    ...
    JOIN ssp_partners sp ON cs.ssp_partner_id = sp.id
    WHERE cs.campaign_id = -1 AND cs.stat_date BETWEEN ? AND ?
";
$params = [$date_from, $date_to];
$types = "ss";

if ($selected_partner_id) {
    $sql .= " AND cs.ssp_partner_id = ?";
