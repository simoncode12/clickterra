<?php
// File: /publisher/zone-action.php (FINAL - Secure Zone Creation with Ad Format and Conditional Size)

require_once __DIR__ . '/init.php';

// Pastikan request adalah POST dan tombol add_zone ditekan
...
// --- Verifikasi Keamanan Penting ---
// Pastikan situs ini benar-benar milik publisher yang sedang login dan sudah disetujui (approved)
// untuk mencegah publisher A membuat zona di situs milik publisher B.
...
if ($site_check_result->num_rows !== 1) {
    // Jika tidak cocok, berarti ada upaya tidak sah atau ID situs tidak valid/belum disetujui
    $_SESSION['error_message'] = 'Invalid site specified or site not approved. You can only add zones to your own approved sites.';
    header('Location: sites.php');
    exit();
}
// --- Akhir Verifikasi Keamanan ---

// Jika verifikasi lolos, masukkan zona baru ke database
